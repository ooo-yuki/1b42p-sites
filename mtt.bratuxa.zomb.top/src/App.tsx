...
const CHAR_ABILITIES: Record<string, { lines: string[]; sup: string }> = {
  ...
  arbuz: {
    ...
    sup: '🌪️ СУПЕР — Цветочная воронка на C: в точке поверхности под прицелом 4с зелёная воронка (r=5м) затягивает всех строго в центр. Босса и сталкеров не трогает. Кд 15с.',
  },
};
