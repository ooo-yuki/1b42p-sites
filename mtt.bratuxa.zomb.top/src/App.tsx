...
const CHAR_ABILITIES: Record<string, { lines: string[]; sup: string }> = {
  ...
  arbuz: {
    ...
    sup: '🌪️ СУПЕР — Цветочная воронка на C: в точке поверхности под прицелом 4с зелёная воронка (r=5м) затягивает ВСЕХ строго в центр — и нечисть, и сталкеров, и даже босса. Кд 15с.',
  },
};
