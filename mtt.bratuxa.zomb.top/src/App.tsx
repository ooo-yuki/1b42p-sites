...
const CHAR_ABILITIES: Record<string, { lines: string[]; sup: string }> = {
  ...
  sunstrike: {
    ...
    sup: '☀️ СУПЕР — Луч Санстрайка на C: метка на точке врага, через 0.5с удар с неба. Заряд 0–15 (+1 за убийство руками, фраги от луча не идут, каст сжигает заряд в 0, урон по тебе — в 0): урон 20→142, радиус 3→5м. Кд 30с.',
  },
};
