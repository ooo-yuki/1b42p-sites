...
export const TREE = [
  ...
  { br: '🍺 Ветка Глотки — только бухло', id: 'samogon', name: '⚗️ Самогонный аппарат', desc: '+5 к силе глотка', max: 5, base: 800, g: 7, fx(Z) { Z.click += 5; } },
...
export const ARTS = [
  { id: 'goldshot', name: '🥃 Золотая Рюмка 42', desc: '×2 ко всему бухлу. Навсегда.', cost: 5000, fx(Z) { Z.mult *= 2; } },
  { id: 'amulet', name: '🧿 Амулет Трезвости', desc: '+1 HP/сек, −30% урона (toxic×0.7)', cost: 4000, fx(Z) { Z.regen += 1; Z.toxic *= 0.7; } },
  { id: 'titan', name: '🛡️ Титановая Печень', desc: '+100 к макс. здоровью', cost: 6000, fx(Z) { Z.maxhp += 100; Z.hp += 100; } },
  { id: 'barrel', name: '🛢️ Бочка Бесконечности', desc: '+10 бухла/сек', cost: 8000, fx(Z) { Z.auto += 10; } },
];
