...
export const CHARACTERS = [
  ...
  { id: 'demon', name: 'Злой Демон Чаев', emoji: '😈', img: 'chars/demon.jpg',
    desc: 'Чем ниже HP — тем сильнее: множитель ×1…×3. Глоток ×2, но урон ×2. На 0 HP — Демоническая форма ×5 на 10 сек, потом бутылка бьётся. Спасает 😇 Очищение (цена капельницы): снимает форму, HP 30%.',
