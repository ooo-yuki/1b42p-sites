...
export const CHARACTERS = [
  { id: 'vladimir', name: 'Владимир Владимирович Чаев', emoji: '🧔', img: 'chars/vladimir.jpg',
    desc: 'Стабильный и солидный.',
    stats: ['🍾 Глоток: +0.02 к клику навсегда', '🏷️ Каждый глоток: −0.2% к ценам (макс −20%)', '💊 Хилки +25%', '⚡ Пассивно: +0.2 бухла/сек'],
    hint: 'Медленно, надёжно, с постоянным ростом. Стартовый.' },
  { id: 'ghost', name: 'Мёртвый Чаев', emoji: '👻', img: 'chars/ghost.jpg',
    desc: 'Хрупкий и быстрый.',
    stats: ['👻 Нет похмелья — вместо HP душа', '💜 Душа: реген +2/сек, глоток −5', '💫 Глоток ×3, всё ×1.25', '💥 Душа в 0 — бутылка бьётся, без закрытия'],
    hint: 'Игра на грани.' },
  { id: 'winline', name: 'Винлайн Чаев', emoji: '🎰', img: 'chars/winline.jpg',
    desc: 'Казино внутри кликера.',
    stats: ['🎲 Глоток случайно ×0.5…×2.5', '🏺 Артефакты: 20% двойные, 10% пустышки', '🎰 Ставка: 10% бухла, шанс 45% — возврат ×2'],
    hint: 'Полный рандом и азарт.' },
  { id: 'demon', name: 'Злой Демон Чаев', emoji: '😈', img: 'chars/demon.jpg',
    desc: 'Максимальный риск.',
    stats: ['📈 Мульт ×1…×3 — чем ниже HP, тем сильнее', '🍾 Глоток ×2, но урон ×2', '😈 0 HP — форма ×5 на 10 сек, потом бутылка бьётся', '😇 Очищение спасает: цена капельницы, HP 30%'],
