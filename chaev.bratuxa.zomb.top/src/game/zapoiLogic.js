...
export const CHARACTERS = [
  ...
  { id: 'demon', name: 'Злой Демон Чаев', emoji: '😈', img: 'chars/demon.jpg', drink: 'jager/demon.jpg',
    ...
    stats: ['📈 Мульт ×1…×3 — чем ниже HP, тем сильнее', '🍾 Глоток ×2, но урон ×2', '😈 0 HP — форма ×5 на 10 сек, потом бутылка бьётся', '🔥 Демонические пикули: лечат + продлевают форму на 10 сек', '😇 Очищение спасает: цена капельницы, HP 30%'],
