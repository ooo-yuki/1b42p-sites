...
export const TREE: UpgradeDef[] = [
  ...
  { br: '🩹 Ветка Трезвости — лечат HP, жрут бухло', id: 'kapel', name: '💉 Медсестра 42', desc: 'Капельница +40% к лечению, шприц и очищение дешевле на 10% (шприц лечит полное HP, очищение ставит 30% — см. heals.ts)', max: 5, base: 250, g: 6, fx() {} },
  ...
  { br: '🍀 Ветка Удачи — ставки и джекпоты', id: 'stream', name: '🍀 Удача 42', desc: '+2% удачи: ставка чаще заходит, джекпоты чаще, пустышек меньше', max: 5, base: 300, g: 6, fx(z) { z.luck = (z.luck || 0) + 2; } },
];
