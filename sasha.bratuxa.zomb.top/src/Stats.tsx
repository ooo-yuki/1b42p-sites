...
const ORDER = ['hub', 'chaev', 'doom', 'evaelph', 'smolgrad', 'miqqil', 'setden', 'svyatoslav', 'denis', 'sasha', 'gtaevv', 'brohacho', '1b42p', 'mtt', 'laiv42', '42vs', 'ai-714ef0', 'pampers', 'shturm', 'skitons'];
interface HistPoint {
  ts: string;
