...
const NAMES: Record<string, string> = {
  ...
  '42vs': '42VS', 'ai-714ef0': 'AI', pampers: 'Памперс', shturm: 'ШТУРМ-43', skitons: 'Skitons', podval42: 'Подвал',
};
const COLORS: Record<string, string> = {
  ...
  '42vs': '#4db6ac', 'ai-714ef0': '#e040fb', pampers: '#aed581', shturm: '#ff8a65', skitons: '#7986cb', podval42: '#8c9eff',
};
const ORDER = ['hub', 'chaev', 'doom', 'evaelph', 'smolgrad', 'miqqil', 'setden', 'svyatoslav', 'denis', 'sasha', 'gtaevv', 'brohacho', '1b42p', 'mtt', 'laiv42', '42vs', 'ai-714ef0', 'pampers', 'shturm', 'skitons', 'podval42'];
interface HistPoint {
  ts: string;
