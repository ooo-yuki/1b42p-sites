...
export const CASES: CaseDef[] = [
  { id: 'barracks', icon: 'barracks', name: 'Казарма', price: 100, desc: 'Скромно, но со вкусом',
    drops: [
      { icon: 'hardhat', label: 'Каска', amount: 40, w: 35 },
      { icon: 'boots', label: 'Берцы', amount: 70, w: 30 },
      { icon: 'medal', label: 'Медалька', amount: 110, w: 20 },
      { icon: 'flame', label: 'Запал', amount: 200, w: 11 },
      { icon: 'coins', label: 'Касса части', amount: 400, w: 4 },
    ] },
  { id: 'arsenal', icon: 'arsenal', name: 'Арсенал', price: 300, desc: 'Для тех, кто в теме',
    drops: [
      { icon: 'glock', label: 'Глок', amount: 120, w: 32 },
      { icon: 'vest', label: 'Броник', amount: 200, w: 28 },
      { icon: 'truck', label: 'Урал', amount: 320, w: 22 },
      { icon: 'rocket', label: 'Ракета', amount: 550, w: 13 },
      { icon: 'crown', label: 'Звезда генерала', amount: 1000, w: 5 },
    ] },
  { id: 'hq42', icon: 'hq42', name: 'Штаб 42', price: 1000, desc: 'Олл-ин по-батальонному',
    drops: [
      { icon: 'radio', label: 'Рация', amount: 400, w: 30 },
      { icon: 'map', label: 'Карта', amount: 650, w: 27 },
      { icon: 'anchor', label: 'Якорь Авроры', amount: 1000, w: 23 },
      { icon: 'eagle', label: 'Орёл', amount: 1800, w: 14 },
      { icon: 'jackpot', label: 'Джекпот 42', amount: 3000, w: 6 },
    ] },
];
